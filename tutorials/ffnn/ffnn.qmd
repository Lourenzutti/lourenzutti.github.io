...
<img src="images/nn1.svg" alt="A drawing of an elephant." width="100%">
...
<img src="images/nn2.svg" alt="A drawing of an elephant." width="100%">
...
I've always found the terminology very confusing without looking at the equations. For example, when I say that weights amplify or reduce the signal, how exactly does that happen? How exactly do receptors collect and aggregate all the signals? How do neurons process the signals passed by the receptors? 
