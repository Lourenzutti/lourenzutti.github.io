...
As you can see, following the prescribed methodology above would yield a false positive rate of 15%, three times the nominal rate of 5%. The sequential hypothesis tests significantly inflate the type I error. 
